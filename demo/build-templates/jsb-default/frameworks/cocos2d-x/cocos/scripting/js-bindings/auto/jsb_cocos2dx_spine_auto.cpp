...
static bool js_cocos2dx_spine_SkeletonRenderer_setAttachmentForJson(se::State& s)
{
    spine::SkeletonRenderer* cobj = (spine::SkeletonRenderer*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_spine_SkeletonRenderer_setAttachmentForJson : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 7) {
        cocos2d::Map<std::basic_string<char>, cocos2d::Texture2D *> arg0;
        std::string arg1;
        std::string arg2;
        std::string arg3;
        std::string arg4;
        ...
        SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_SkeletonRenderer_setAttachmentForJson : Error processing arguments");
        int result = cobj->setAttachmentForJson(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
...
SE_BIND_FUNC(js_cocos2dx_spine_SkeletonRenderer_setAttachmentForJson)
...
bool js_register_cocos2dx_spine_SkeletonRenderer(se::Object* obj)
{
    ...
    cls->defineFunction("setAttachmentForJson", _SE(js_cocos2dx_spine_SkeletonRenderer_setAttachmentForJson));
