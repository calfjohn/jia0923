...
cc.Class({
    ...
    onLoad: function () {
        this.rewardNum = this.widget("packRewardItem/number");
    ...
    init:function(idx,data,noRefresh) {
        ...
        this.widget("packRewardItem/reelItem").active = kf.inArray(reelList,data.Type);
        this.widget("packRewardItem/rewardItem").active = !this.widget("packRewardItem/reelItem").active;
        ...
        var itemType = this.widget("packRewardItem/reelItem").active?"packRewardItem/reelItem/":"packRewardItem/rewardItem/";
        ...
        var iconStr = this.widget("packRewardItem/reelItem").active?"mask/icon":"icon";
